...
const mapDispatchToProps = dispatch =>{
  console.log("**action is now dispacting");
  return{
      onLogin : (email , password) => dispatch(auth(email , password)),
  };
};
const mapStateToProps = state => {
  console.log("**MAP STATE TO PROPS" , state); // IN {state.places.places} places is a reducer and the last places is the variable in stores's State
  return{
